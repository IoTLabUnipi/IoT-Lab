...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>2.92271789268856</x>
        <y>6.252599339312383</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>40.590100835295374</x>
        <y>22.89695781513885</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>6.997538823996274</x>
        <y>47.93652977341106</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>15.374361349671375</x>
        <y>70.57600337584702</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>32.048260501214564</x>
        <y>32.004606910553065</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>30.63570149406142</x>
        <y>3.117102394319071</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.7652276997181704 0.0 0.0 1.7652276997181704 166.85074444872393 157.69001117827898</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>i=0;	&#xD;
while(i&lt;100){	&#xD;
  YIELD_THEN_WAIT_UNTIL(msg.equals("My output"));&#xD;
  log.log(msg+":"+id+":"+msg+"\n");	&#xD;
  i++;	&#xD;
}</script>
      <active>true</active>
